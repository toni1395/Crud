            ...
            <div class="row">
                ...
                <form method="post" action="/mahasiswas">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fakultas" placeholder="masukan fakultas" name="fakultas" value="{{old('fakultas')}}">
                    </div>
                    ...
                    <button type="submit" class="btn btn-dark">Tambah data mahasiswa</button>
